...
app.get('/report/:name', (req, res) => {
    ...
    var today = new Date();
    var message1 = `Astazi,  ${today}, totul este OK la domiciliu. Mentionez ca nu am intrat in contact cu niciun confirmat de COVID-19 si ca nu prezint niciun simptom.  `;
